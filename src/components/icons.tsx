...
export function Flame(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" stroke="none" {...props}>
      <path d="M12.87 2.08c-.46-.38-1.16-.14-1.28.45-.48 2.37-1.74 4.41-3.4 5.92-2.15 1.96-3.44 4.74-3.44 7.79 0 4.83 3.69 8.76 8.25 8.76s8.25-3.93 8.25-8.76c0-4.14-2.38-7.79-5.91-9.45-.61-.29-1.29.13-1.34.8-.09 1.15-.55 2.21-1.31 3.01-.29.31-.79.13-.85-.29-.44-3.11-.97-6.23 1.03-8.23z" />
    </svg>
  );
}
