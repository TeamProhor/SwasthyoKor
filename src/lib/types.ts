...
export function getSuggestedSizesForUnit(
  unit: ProductUnit,
): { amount: number; label: string }[] {
  switch (unit) {
    case "jar":
      return [
        { amount: 1, label: "১ জার" },
        { amount: 2, label: "২ জার (কম্বো)" },
        { amount: 3, label: "৩ জার" },
      ];
    case "bottle":
      return [
        { amount: 1, label: "১ বোতল" },
        { amount: 2, label: "২ বোতল (কম্বো)" },
        { amount: 3, label: "৩ বোতল" },
      ];
    case "piece":
      return [
        { amount: 1, label: "১ পিস" },
        { amount: 2, label: "২ পিস (কম্বো)" },
        { amount: 3, label: "৩ পিস" },
        { amount: 5, label: "৫ পিস (সেট)" },
      ];
    case "packet":
      return [
        { amount: 1, label: "১ প্যাকেট" },
        { amount: 2, label: "২ প্যাকেট" },
        { amount: 3, label: "৩ প্যাকেট" },
      ];
    case "box":
      return [
        { amount: 1, label: "১ বক্স" },
        { amount: 2, label: "২ বক্স" },
      ];
    case "gram":
      return [
        { amount: 100, label: "১০০ গ্রাম" },
        { amount: 200, label: "২০০ গ্রাম" },
        { amount: 250, label: "২৫০ গ্রাম" },
        { amount: 500, label: "৫০০ গ্রাম" },
        { amount: 1000, label: "১ কেজি" },
      ];
    case "kg":
      return [
        { amount: 1, label: "১ কেজি" },
        { amount: 2, label: "২ কেজি" },
        { amount: 5, label: "৫ কেজি" },
      ];
    case "ml":
      return [
        { amount: 100, label: "১০০ মি.লি." },
        { amount: 250, label: "২৫০ মি.লি." },
        { amount: 500, label: "৫০০ মি.লি." },
        { amount: 1000, label: "১ লিটার" },
      ];
    case "litre":
      return [
        { amount: 1, label: "১ লিটার" },
        { amount: 2, label: "২ লিটার" },
        { amount: 5, label: "৫ লিটার" },
      ];
    default:
      return [{ amount: 1, label: "১ পিস" }];
  }
}
